...
import (
	context "context"
	reflect "reflect"
	models "yt-video-transcriptor/models"
...
func (m *MockRepository) Create(arg0 context.Context, arg1 models.VideoRequest) error {
	m.ctrl.T.Helper()
...
func (m *MockRepository) Update(arg0 context.Context, arg1 string, arg2 models.YTVideo) error {
	m.ctrl.T.Helper()
